setInterval(() => {
  const textarea1 = document.querySelector(
      '[data-test="checklist-question-answer-text-input"]');
  ...
  if (questionSection &&
    ...
    setInterval(() => {
      ...
      const questionItems = document.querySelector('[data-test="question-s"]')
      ...
      setTimeout(() => {
        ...
        setTimeout(
            () => {
                ...
                document
                    .querySelector('[data-test="question-response-nav-button"]')
                    .click()
    ...
    setInterval(() => {
      const nativeTextAreaValueSetter =
          Object
              .getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,
                                        'value')
              .set;
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(
                  () => {document
                             .querySelector(
                                 '[data-test="question-response-nav-button"]')
                             .click()},
                  50);
            }, 50);
          }, 50);
